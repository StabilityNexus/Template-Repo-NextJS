    ...
    <div className="w-full flex flex-col items-center gap-6 mt-16 px-4">
      ...
      >
        ...
        <div className="flex items-center gap-4 flex-1 justify-center sm:justify-start w-full px-4">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#FAF5FF] text-[#9333EA]">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 002 2h2a2 2 0 002-2z" />
            </svg>
          </div>
          <div>
            <span className="text-xl font-extrabold text-neutral-900 font-sans tracking-tight block">$24.7M+</span>
        ...
        <div className="flex items-center gap-4 flex-1 justify-center sm:justify-start w-full px-4">
          ...
          <div>
            <span className="text-xl font-extrabold text-neutral-900 font-sans tracking-tight block">12,845+</span>
        ...
        {/* Stat Item 3 */}
        <div className="flex items-center gap-4 flex-1 justify-center sm:justify-start w-full px-4">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#F0FDF4] text-[#16A34A]">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
            </svg>
          </div>
          <div>
            <span className="text-xl font-extrabold text-neutral-900 font-sans tracking-tight block">3,120+</span>
        ...
        {/* Stat Item 4 */}
        <div className="flex items-center gap-4 flex-1 justify-center sm:justify-start w-full px-4">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#FFFBEB] text-[#D97706]">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
            </svg>
          </div>
          <div>
            <span className="text-xl font-extrabold text-neutral-900 font-sans tracking-tight block">99.9%</span>
      ...
      <span className="text-[10px] font-extrabold tracking-[0.2em] text-neutral-400 uppercase font-sans mt-4">
        WHY WINDMILL?
      </span>
    </div>
  );
